...
// kiểm tra bằng lệnh ipconfig và thấy IP WiFi hiện tại của bạn VD: Ip cục wifi Của hưng => 'http://172.16.51.134:5000/api'; hay của nhân 'http://192.168.1.100:5000/api';
